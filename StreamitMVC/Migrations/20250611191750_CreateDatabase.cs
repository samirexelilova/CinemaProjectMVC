    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HallPrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HallPrices_HallTypes_HallTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Actors_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RejectedComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HallId = table.Column<int>(type: "int", nullable: false),
                    CinemaId = table.Column<int>(type: "int", nullable: false),
                    HallPriceId = table.Column<int>(type: "int", nullable: false),
                    LanguageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sessions_HallPrices_HallPriceId",
                        column: x => x.HallPriceId,
                        principalTable: "HallPrices",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorSocialMedias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActorSocialMedias_Actors_ActorId",
                        column: x => x.ActorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Actors_PositionId",
                table: "Actors",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_ActorSocialMedias_ActorId",
                table: "ActorSocialMedias",
                column: "ActorId");
